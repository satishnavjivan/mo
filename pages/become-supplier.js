...
import { CAPTCHA_SITE_KEY, BECOME_SUPPLIER, HEADER_FOOTER_ENDPOINT } from '../src/utils/constants/endpoints';
...
export default function becomeSupplier({ headerFooter }) {
	const seo = {
		title: 'Become a Supplier',
		description: 'Become a Supplier',
		og_image: [],
		og_site_name: 'Become a Supplier',
		robots: {
			index: 'index',
			follow: 'follow',
		},
