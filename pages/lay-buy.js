			...
			<section>
				<div className="max-w-[1320px] mx-auto space-y-5">
					...
					<div className='grid grid-cols-1 space-y-3'>
						...
						<h2 className="font-jost text-3xl font-semibold mt-5 text-[#7382d6] pt-4"> Shopping at Mattress Offers just got easier</h2>
						<p>Don't you hate it when it's a few days before you get paid, you see an amazing price on an item you must have, but there's no money in your account? Don't let your dream item get away from you, use Laybuy to help transform the way you buy things online. Here at Mattress Offers we love Laybuy as it allows our customers the freedom to have the products they want now, and pay in easy to manage instalments . You pay only the purchase price by choosing this method, and process couldn't be simpler or easier. Take advantage of Laybuy , all the great online shops are using it. Shop with Laybuy and get the products you want now!</p>
