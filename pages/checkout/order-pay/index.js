...
export default function Checkout({ headerFooter }) {
	...
	return (
		<Layout headerFooter={headerFooter || {}}>
			<h1 className='relative pb-2 text-center font-jost text-2xl md:text-3xl lg:text-4xl font-semibold mb-10 title-border'>Pay for order</h1>
			{wc_order_key == orderData.order_key && orderData.status == 'pending' ?
				<>
					<div key="check-outform" className='border border-gray-300 p-2 max-w-3xl mx-auto'>
								...
								{paypalButtonBisible && createdOrderData != null ? <>
									...
									<div id='checkoutbtn' className="woo-next-place-order-btn-wrap mt-5">
										<button
											...
											className='inline-block border border-victoria-600 bg-victoria-700 text-white py-2 px-3 hover:bg-transparent hover:text-victoria-700 w-full '
											type="submit"
										>
											Place Order
										</button>
